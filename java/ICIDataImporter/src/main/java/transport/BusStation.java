...
public class BusStation extends Station {
	...
	public BusStation() throws IOException {
		...
		dailyProfiles = new File(Util.getRootFolder(),
				"paris/mobilite/validations-sur-le-reseau-de-surface-profils-horaires-par-jour-type-1er-sem.csv");
		dailyValidation = new File(Util.getRootFolder(),
				"paris/mobilite/validations-sur-le-reseau-de-surface-nombre-de-validations-par-jour-1er-sem.csv");
